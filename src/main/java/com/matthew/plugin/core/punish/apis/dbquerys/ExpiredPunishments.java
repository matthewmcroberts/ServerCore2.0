...
public class ExpiredPunishments {
    ...
    /**
     * Get the staff member who issued the punishment in the 'expired_punishments' table
     *
     * @param player - Player whose UUID is being queried
    ...
    /**
     * Get when the punishment that is currently expired in the 'expired_punishments' table expired
     *
     * @param player - Player whose UUID is being queried
    ...
    /**
     * Get when the punishment that is currently expired in the 'expired_punishments' table was issued
     *
     * @param player - Player whose UUID is being queried
    ...
    /**
     * Get the type of punishment that was issued to the player in the 'expired_punishments' table
